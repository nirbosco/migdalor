...
// (משוב אמפתי לחותם + ניתוח אבחוני למנטור) → כתיבה ל-Supabase (service key).
//
...
- בנוסף נסח mentor_note_draft: טיוטת משוב לחותם בטון בונה ואמפתי, שהמנטור יערוך לפני שליחה.
...
{"summary": "פסקת אבחון קצרה: מה מאפיין את ההוראה בשיעור הזה",
 ...
 "talking_points": ["נקודות לשיחת המנטור עם החותם"],
 "mentor_note_draft": "טיוטת משוב לחותם, 4-8 משפטים, גוף שני, חם ובונה"}`;
